	 ...
	 class category
	 {
	 	...
	 	public function insert_category($catName){
	 		...
	 		if(empty($catName)){
	 			...
	 			if($result){
	 				$alert = "<span class='success'>Insert Category Successfuly</span>";
	 				return $alert;
	 			}
	 			else{
	 	...
	 	public function update_category($catName,$id){
	 		...
	 		if(empty($catName)){
	 			...
	 			if($result){
	 				$alert = "<span class='success'>update Category Successfuly</span>";
	 				return $alert;
	 			}
	 			else{
	 	...
	 	public function del_category($id){
	 		...
	 		if($result){
	 				$alert = "<span class='success'>Delete Category Successfuly</span>";
	 				return $alert;
	 			}
	 			else{
